 ...
 * 
 * @author Morteza Adigozalpour
 * 
 */
public class CRC16 {

    static final int[] CRC16_TABEL = { 0x0000, 0xC0C1, 0xC181, 0x0140, 0xC301,
    ...
    /**
     * Computes ANSI CRC-16 hash of plain TEXT ASCII bytes
     * @param s
     * @return
     */
    public int getCRC16(String s) {
        int crcValue = 0x0000;
        byte[] bytes = s.getBytes();
        for (byte b : bytes) {
            crcValue = (crcValue >>> 8) ^ CRC16_TABEL[(crcValue ^ b) & 0xff];
        }
        return crcValue;
    }
